...
(function(){{
  ...
  function buildReportHtml(){{
    ...
    var css = 'body{background:#eef1f7;font-family:Calibri,Arial,sans-serif;margin:0;padding:10px 0;}'
      + 'table{border-collapse:collapse;}'
      + 'td[bgcolor="#1e40af"]{background-color:#1e40af!important;}'
      + 'td[bgcolor="#1e40af"] font{color:#ffffff!important;}';
