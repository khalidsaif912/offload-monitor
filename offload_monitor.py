...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    # If no flights at all, show a NIL card
    if not cards_html:
        cards_html = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif; margin-bottom:14px;">
      <tr>
        <td style="background-color:{hdr_bg}; padding:9px 12px; border:1px solid {hdr_border};
            font-family:Calibri,Arial,sans-serif; color:{hdr_color}; font-size:12.5px;">
          <strong>✈ NIL</strong>
        </td>
      </tr>
      <tr>
        <td style="padding:6px 12px; background-color:{ops_bg}; border:1px solid {ops_border};
            font-family:Calibri,Arial,sans-serif; font-size:11px; color:{text_dark};">
          Email: <strong>—</strong>
          <span style="color:#8aa2c7;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          Ramp Received: <strong>—</strong>
          <span style="color:#8aa2c7;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          CMS Completed: <strong>—</strong>
          <span style="color:#8aa2c7;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          Pieces Verified: <strong>—</strong>
          <span style="color:#8aa2c7;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          Remarks: <strong>—</strong>
        </td>
      </tr>
      <tr>
        <td style="padding:14px 10px; border:1px solid {cell_border};
            color:{nil_color}; text-align:center; font-style:italic; font-size:12px;
            font-family:Calibri,Arial,sans-serif; background:{row_even};">
              ...
              <tr>
                ...
                <td valign="top" style="padding-right:18px; border-right:2px solid #8b0000;">
                  <div style="font-family:Arial Black,Arial,sans-serif; font-size:28px; font-weight:900;
                              color:#8b0000; letter-spacing:2px; line-height:1;">TRANSOM</div>
