...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;width:30px;"><font color="#ffffff">#</font></td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;"><font color="#ffffff">AWB</font></td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;"><font color="#ffffff">PCS</font></td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;"><font color="#ffffff">KGS</font></td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;"><font color="#ffffff">Priority</font></td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;"><font color="#ffffff">Description</font></td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;"><font color="#ffffff">ULD</font></td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;"><font color="#ffffff">Offloading Reason</font></td>
      </tr>
      <tr>
    ...
    <div style="margin-top:14px;border-radius:8px;overflow:hidden;border:1px solid #c7d4f0;font-family:Calibri,Arial,sans-serif;">
      ...
      <div style="overflow-x:auto;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;font-size:13px;">
          <tr>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;width:30px;font-size:13px;"><font color="#ffffff">#</font></td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;font-size:13px;"><font color="#ffffff">AWB</font></td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;"><font color="#ffffff">PCS</font></td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;"><font color="#ffffff">KGS</font></td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;"><font color="#ffffff">Priority</font></td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;font-size:13px;"><font color="#ffffff">Description</font></td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;"><font color="#ffffff">ULD</font></td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;font-weight:700;border:1px solid #1e3a8a;font-size:13px;"><font color="#ffffff">Offloading Reason</font></td>
          </tr>
          {rows}
        </table>
      </div>
  ...
  <tr>
    <td style="padding:10px 24px 8px 24px; background-color:#f8faff; border-bottom:1px solid #e4e9f5;">
      <span onclick="window.location.href='../../index.html'"
         style="font-family:Calibri,Arial,sans-serif; font-size:12px; color:#0b3a78; font-weight:700; text-decoration:none; cursor:pointer; display:inline-block;">
        ← Back to Index
      </span>
    </td>
  </tr>
...
(function(){{
  ...
  function buildReportHtml(){{
    ...
    var css = 'body{{background:#eef1f7;font-family:Calibri,Arial,sans-serif;margin:0;padding:10px 0;}}table{{border-collapse:collapse;}}td[bgcolor="#1e40af"]{{background-color:#1e40af!important;}}td[bgcolor="#1e40af"] font{{color:#ffffff!important;color:#ffffff;}}';\n    return '<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><style>' + css + '</style></head><body>' + html + '</body></html>';
  }}
...
def _shift_window(date_dir: str, shift: str) -> tuple[str, str]:
    ...
    if shift == "shift1":
        ...
        start_hm, end_hm, add_day = "13:00", "22:00", 0
    else:
...
def send_shift_report_email(date_dir: str, shift: str) -> None:
    ...
    shift_names = {
        ...
        "shift2": "Afternoon Shift (13:00–22:00)",
...
def _shift_window_for(ref_dt: datetime) -> tuple[datetime, datetime]:
    ...
    if 6 * 60 <= mins < 13 * 60:                # shift1
        start = base.replace(hour=6)
        end   = base.replace(hour=15)
    elif 13 * 60 <= mins < 22 * 60:             # shift2
        start = base.replace(hour=13)
        end   = base.replace(hour=22)
