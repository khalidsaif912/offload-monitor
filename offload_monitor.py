...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif; margin-bottom:14px;">
      <tr>
        <td style="{_nil_label_s}">✈ Flight:</td>
        <td style="{_nil_val_s}">NIL</td>
        <td style="{_nil_label_s}">Date:</td>
        <td style="{_nil_val_s}">—</td>
        <td style="{_nil_label_s}">STD:</td>
        <td style="{_nil_val_s}">—</td>
        <td style="{_nil_label_s}">ETD:</td>
        <td style="{_nil_val_s}">—</td>
      </tr>
      <tr>
        <td style="{_nil_label_s}">DEST:</td>
        <td style="{_nil_val_s} color:#b45309;">—</td>
        <td colspan="6" style="{_nil_val_s}">&nbsp;</td>
      </tr>
      <tr>
        <td style="{_nil_ops_l}">Email:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l}">Ramp Received:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l}">CMS Completed:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l}">Pieces Verified:</td>
        <td style="{_nil_ops_v}">—</td>
      </tr>
      <tr>
        <td style="{_nil_ops_l}">Remarks:</td>
