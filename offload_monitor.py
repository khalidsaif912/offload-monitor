  ...
  <style>
    *,*::before,*::after{{box-sizing:border-box;}}
    ...
    @media(max-width:700px){{
      ...
      /* الأوفلود على الجوال — جدول طبيعي مع سحب أفقي */
      .offload-wrap{{width:100%;max-width:100%;overflow-x:auto!important;overflow-y:hidden!important;-webkit-overflow-scrolling:touch;}}
      .offload-table{{width:1180px!important;min-width:1180px!important;table-layout:fixed!important;border-collapse:collapse!important;}}
      .offload-table thead{{display:table-header-group!important;}}
      .offload-table tbody{{display:table-row-group!important;}}
      .offload-table tr{{display:table-row!important;margin:0!important;border:none!important;background:transparent!important;}}
      .offload-table th,.offload-table td{{display:table-cell!important;width:auto!important;text-align:center!important;vertical-align:middle!important;padding:7px 6px!important;min-height:auto!important;border-left:1px solid #d0d9ee!important;border-right:1px solid #d0d9ee!important;}}
      .offload-table td::before{{content:none!important;display:none!important;}}
      .offload-table td.offload-idx{{padding:18px 6px 7px 28px!important;min-width:58px!important;}}
      .offload-table .offload-row-delete{{top:4px!important;left:4px!important;z-index:2;}}
...
<ul id="ul-csdrescreening" style="margin:4px 0 6px 22px; padding:0; color:#1b1f2a; list-style:none;">
  <li contenteditable="true" tabindex="52" style="outline:none; min-width:40px; padding-left:14px; position:relative;">&nbsp;</li>
</ul>
    </div>
  ...
  <tr><td class="sec-pad" style="padding:14px 24px 0 24px;">
    ...
    <div class="sec-body" style="font-family:Calibri,Arial,sans-serif; font-size:13.5px; color:#1b1f2a; line-height:1.7; margin-top:10px; padding:0 4px;">
      <ul id="ul-special-handover" style="margin:0 0 10px 22px; padding:0; list-style:none; color:#1b1f2a;">
        <li contenteditable="true" tabindex="96" style="outline:none; padding-left:14px; position:relative;">&nbsp;</li>
      </ul>
    </div>
    <div style="border-top:1px solid #e4e9f5; margin-top:14px;"></div>
  </td></tr>
  ...
  <tr><td class="sec-pad" style="padding:14px 24px 0 24px;">
    ...
    <div class="sec-body" style="font-family:Calibri,Arial,sans-serif; font-size:13.5px; color:#1b1f2a; line-height:1.7; margin-top:10px; padding:0 4px;">
      <ul id="ul-other" style="margin:0 0 10px 22px; padding:0; list-style:none; color:#1b1f2a;">
        <li contenteditable="true" tabindex="97" style="outline:none; padding-left:14px; position:relative;">&nbsp;</li>
      </ul>
    </div>
  </td></tr>
...
(function(){{
  ...
  document.addEventListener('DOMContentLoaded', function(){{
    var editableLists = [
      'ul-loadplan','ul-advloading','ul-csdrescreening','ul-handover','ul-special-handover','ul-other',
...
(function(){{
  ...
  function isCustomBulletUl(ul) {{
    if(!ul || !ul.id) return false;
    return ul.id === 'ul-csdrescreening' || ul.id === 'ul-special-handover' || ul.id === 'ul-other';
  }}
