...
def _render_manpower_section(roster: dict, supervisor_display: str = "") -> str:
    ...
    if sup_in_roster:
      ...
      <ul id="ul-supervisors" style="{ul_style}">{sup_li_roster}</ul>
      <button onclick="addListItem('ul-supervisors')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>"""
        ...
        grouped_html += f"""
      <div style="{dept_hdr}">Supervisors:</div>
      <ul id="ul-supervisors" style="{ul_style}"><li contenteditable="true" style="outline:none;"><strong>{supervisor_display}</strong></li></ul>
      <button onclick="addListItem('ul-supervisors')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>"""
    else:
        grouped_html += f"""
      <div style="{dept_hdr}">Supervisors:</div>
      <ul id="ul-supervisors" style="{ul_style}"><li contenteditable="true" style="outline:none;">&nbsp;</li></ul>
      <button onclick="addListItem('ul-supervisors')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>"""
    ...
    for dept, emps in by_dept.items():
      ...
      <ul id="{dept_id}" style="{ul_style}">{items_li}</ul>
    ...
    section_b = f'<div style="{hdr_style}">B) CTU Staff On Duty:</div><ul id="ul-ctu" style="{ul_style}"><li contenteditable="true" style="outline:none;">{nil_item if not True else ""}&nbsp;</li></ul><button onclick="addListItem(\'ul-ctu\')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>'
    section_c = f'<div style="{hdr_style}">C) Support Team:</div><ul id="ul-support" style="{ul_style}">{"".join(f"<li contenteditable=\'true\' style=\'outline:none;\'>{_fmt_name(e)}</li>" for e in on_duty if _is_support(e)) if sup_li else f"<li contenteditable=\'true\' style=\'outline:none;\'>&nbsp;</li>"}</ul><button onclick="addListItem(\'ul-support\')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>'
    section_d = f'<div style="{hdr_style}">D) Sick Leave / No Show / Others:</div><ul id="ul-sickleave" style="{ul_style}"><li contenteditable="true" style="outline:none;">&nbsp;</li></ul><button onclick="addListItem(\'ul-sickleave\')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>'
    section_e = f'<div style="{hdr_style}">E) Annual Leave / Course / Off in Lieu:</div><ul id="ul-annualleave" style="{ul_style}"><li contenteditable="true" style="outline:none;">&nbsp;</li></ul><button onclick="addListItem(\'ul-annualleave\')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>'
    section_f = f'<div style="{hdr_style}">F) Trainee:</div><ul id="ul-trainee" style="{ul_style}"><li contenteditable="true" style="outline:none;">&nbsp;</li></ul><button onclick="addListItem(\'ul-trainee\')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>'
    section_g = f'<div style="{hdr_style}">G) Overtime Justification:</div><ul id="ul-overtime" style="{ul_style}"><li contenteditable="true" style="outline:none;">&nbsp;</li></ul><button onclick="addListItem(\'ul-overtime\')" style="font-size:11px;padding:1px 8px;margin:2px 0 8px;cursor:pointer;background:#eef3fc;border:1px solid #0b3a78;color:#0b3a78;border-radius:3px;">+ Add</button>'
  ...
  function buildReportHtml(){{
    ...
    clone.querySelectorAll('[data-email-keep]').forEach(function(e){{
      ...
      if(bg&&bg!==normC('#f59e0b')&&bg!=='rgb(245,158,11)')
        e.style.backgroundColor='#0b3a78';
    }});
...
def filter_flights_already_in_other_shifts(flights: list[dict], now: datetime) -> list[dict]:
    ...
    for f in flights:
        ...
        if new_awbs and new_awbs.issubset(existing_awbs):
