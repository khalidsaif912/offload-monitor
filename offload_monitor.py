...
(function(){{
  ...
  function sendEmailNow(){{
    ...
    openRecipientsManager('send').then(function(result){{
      ...
      /* ── Step 1: Build the full edited HTML from the DOM ── */
      ...
      /* ── Step 2: Get current file SHA then update index.html in repo ── */
      ...
      /* ── Build the full page HTML (wrap report in the page shell) ── */
