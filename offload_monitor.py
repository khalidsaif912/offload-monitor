...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    if not flights:
        return """
    <div style="margin-top:12px;padding:14px;background:#f8faff;border:1px dashed #c7d4f0;
                border-radius:8px;text-align:center;color:#64748b;
                font-family:Calibri,Arial,sans-serif;font-size:13px;font-weight:600;">
    ...
    for flight in flights:
        ...
        <tr style="background:{bg};">
          <td style="padding:7px 6px;border:1px solid #dde6f5;text-align:center;font-weight:700;">{i}</td>
          <td style="padding:7px 6px;border:1px solid #dde6f5;font-family:'Courier New',monospace;font-size:11px;color:#0b3a78;font-weight:600;">{awb}</td>
          <td style="padding:7px 6px;border:1px solid #dde6f5;text-align:center;font-weight:700;">{pcs}</td>
          <td style="padding:7px 6px;border:1px solid #dde6f5;text-align:center;">{kgs}</td>
          <td style="padding:7px 6px;border:1px solid #dde6f5;text-align:center;">{pri}</td>
          <td style="padding:7px 6px;border:1px solid #dde6f5;">{desc}</td>
          <td style="padding:7px 6px;border:1px solid #dde6f5;text-align:center;">{uld}</td>
          <td style="padding:7px 6px;border:1px solid #dde6f5;">{badge}</td>
        </tr>"""
    ...
    <div style="margin-top:14px;border-radius:8px;overflow:hidden;border:1px solid #c7d4f0;font-family:Calibri,Arial,sans-serif;">
      ...
      <div style="background:linear-gradient(90deg,#0b3a78,#1a56b0);padding:10px 14px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;">
        ...
        <div style="display:flex;align-items:center;gap:10px;">
          <a href="{update_link}" target="_blank" style="background:#ef4444;color:#fff;padding:5px 14px;border-radius:6px;font-size:11px;font-weight:700;text-decoration:none;">⟳ UPDATE</a>
