...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    for flight in flights:
        ...
        _lbl_auto = 'width:8%; white-space:nowrap;'
        _val_w    = 'width:12%;'
        flight_hdr_table = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        ...
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{flt}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">Date:</td>
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{date}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">STD:</td>
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{std_display}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">ETD:</td>
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{etd_display}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">DEST:</td>
        <td style="{_hdr_val_s} {_val_w} color:#b45309;" contenteditable="true" tabindex="{_next_ti()}">{dest}</td>
      </tr>
    </table>"""

        # ── Ops + Remarks row (single row — same style as flight header) ──
        ops_row_table = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif; table-layout:fixed;">
      <tr>
        <td style="{_hdr_label_s} {_lbl_auto}">Email:</td>
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{email}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">Ramp:</td>
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{physical}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">CMS:</td>
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{cms}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">Verified:</td>
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{verified}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">Remarks:</td>
        <td style="{_hdr_val_s} {_val_w}" contenteditable="true" tabindex="{_next_ti()}">{remarks}</td>
      </tr>
    </table>"""
    ...
    if not cards_html:
        ...
        nil_col_headers = (
            ...
            + _nil_col('PCS:', 'width:55px;')
            + _nil_col('KGS:', 'width:65px;')
            + _nil_col('Priority:', 'width:70px;')
            + _nil_col('Description:', '')
            + _nil_col('ULD:', 'width:70px;')
            + _nil_col('Offloading Reason:', 'width:150px;')
            + '</tr>'
        )

        _lbl_auto = 'width:1%; white-space:nowrap;'
        _nil_lbl_auto = 'width:8%; white-space:nowrap;'
        _nil_val_w    = 'width:12%;'
        cards_html = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif; table-layout:fixed;">
      <tr>
        <td style="{_nil_label_s} {_nil_lbl_auto}">✈ Flight:</td>
        <td style="{_nil_val_s} {_nil_val_w}">NIL</td>
        <td style="{_nil_label_s} {_nil_lbl_auto}">Date:</td>
        <td style="{_nil_val_s} {_nil_val_w}">—</td>
        <td style="{_nil_label_s} {_nil_lbl_auto}">STD:</td>
        <td style="{_nil_val_s} {_nil_val_w}">—</td>
        <td style="{_nil_label_s} {_nil_lbl_auto}">ETD:</td>
        <td style="{_nil_val_s} {_nil_val_w}">—</td>
        <td style="{_nil_label_s} {_nil_lbl_auto}">DEST:</td>
        <td style="{_nil_val_s} {_nil_val_w} color:#b45309;">—</td>
      </tr>
    </table>
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif; table-layout:fixed;">
      <tr>
        <td style="{_nil_label_s} {_nil_lbl_auto}">Email:</td>
        <td style="{_nil_val_s} {_nil_val_w}">—</td>
        <td style="{_nil_label_s} {_nil_lbl_auto}">Ramp:</td>
        <td style="{_nil_val_s} {_nil_val_w}">—</td>
        <td style="{_nil_label_s} {_nil_lbl_auto}">CMS:</td>
        <td style="{_nil_val_s} {_nil_val_w}">—</td>
        <td style="{_nil_label_s} {_nil_lbl_auto}">Verified:</td>
        <td style="{_nil_val_s} {_nil_val_w}">—</td>
        <td style="{_nil_label_s} {_nil_lbl_auto}">Remarks:</td>
        <td style="{_nil_val_s} {_nil_val_w}">—</td>
      </tr>
    </table>
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
