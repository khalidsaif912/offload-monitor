...
def _render_manpower_section(roster: dict, supervisor_display: str = "", import_roster: dict | None = None) -> str:
    ...
    def _fmt_name(emp):
        ...
        return (
            ...
            f'style="display:inline-flex;gap:8px;align-items:baseline;font-family:Calibri,Arial,sans-serif;">'
...
(function(){{
  ...
  function renderSnSelection(li, item) {{
    ...
    li.innerHTML = '<span data-sn="' + escapeHtml(item.sn) + '" data-name="' + escapeHtml(item.name) + '" '
                 + 'style="display:inline-flex;gap:8px;align-items:baseline;font-family:Calibri,Arial,sans-serif;">'
