            ...
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                ...
                <td valign="top" style="padding-right:18px; border-right:2px solid #8b0000;">
                  <span style="font-family:Arial Black,Arial,sans-serif; font-size:28px; font-weight:900;
                              color:#8b0000 !important; letter-spacing:2px; line-height:1; display:block;
                              mso-style-textfill-fill-color:#8b0000;">TRANSOM</span>
                  <div style="font-family:Arial,sans-serif; font-size:10px; font-weight:600;
                              color:#888; letter-spacing:3px; margin-top:2px; text-transform:uppercase;">Cargo</div>
                </td>
                <!-- Contact info -->
