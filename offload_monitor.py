...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr style="background:#1e40af;" bgcolor="#1e40af">
        <td style="padding:7px 6px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;width:30px;">#</td>
        <td style="padding:7px 6px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;">AWB</td>
        <td style="padding:7px 6px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;">PCS</td>
        <td style="padding:7px 6px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;">KGS</td>
        <td style="padding:7px 6px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;">Priority</td>
        <td style="padding:7px 6px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;">Description</td>
        <td style="padding:7px 6px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;">ULD</td>
        <td style="padding:7px 6px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;">Offloading Reason</td>
      </tr>
      <tr>
    ...
    <div style="margin-top:14px;border-radius:8px;overflow:hidden;border:1px solid #c7d4f0;font-family:Calibri,Arial,sans-serif;">
      ...
      <div style="overflow-x:auto;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;font-size:13px;">
          <tr style="background:#1e40af;" bgcolor="#1e40af">
            <td style="padding:9px 8px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;width:30px;font-size:13px;">#</td>
            <td style="padding:9px 8px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;font-size:13px;">AWB</td>
            <td style="padding:9px 8px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;">PCS</td>
            <td style="padding:9px 8px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;">KGS</td>
            <td style="padding:9px 8px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;">Priority</td>
            <td style="padding:9px 8px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;font-size:13px;">Description</td>
            <td style="padding:9px 8px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;">ULD</td>
            <td style="padding:9px 8px;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;font-size:13px;">Offloading Reason</td>
          </tr>
          {rows}
        </table>
      </div>
  ...
  <tr>
    <td style="padding:10px 24px 8px 24px; background-color:#f8faff; border-bottom:1px solid #e4e9f5;">
      <span onclick="window.location.href='../../index.html'"
         style="font-family:Calibri,Arial,sans-serif; font-size:12px; color:#0b3a78; font-weight:700;
...
(function(){{
  ...
  function buildReportHtml(){{
    ...
    return '<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><style>'
      ...
      + 'table{{border-collapse:collapse;}}img{{max-width:100%;height:auto;display:block;}}'
      + 'a,span[onclick]{{color:#0b3a78;text-decoration:none;cursor:pointer;}}'
      + 'tr[style*="background:#1e40af"] td, tr[style*="background:#1e40af"] th{{background-color:#1e40af!important;color:#ffffff!important;-webkit-print-color-adjust:exact;print-color-adjust:exact;}}'
      + 'tr[style*="background:#0b3a78"] td, tr[style*="background:#0b3a78"] th{{background-color:#0b3a78!important;color:#ffffff!important;-webkit-print-color-adjust:exact;print-color-adjust:exact;}}'
...
def _shift_window_for(ref_dt: datetime) -> tuple[datetime, datetime]:
    ...
    if 6 * 60 <= mins < 15 * 60:                # shift1
        start = base.replace(hour=6)
        end   = base.replace(hour=15)
    elif 15 * 60 <= mins < 22 * 60:             # shift2
        start = base.replace(hour=15)
