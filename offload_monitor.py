...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        ...
        <td colspan="4" style="{_hdr_val_s} font-size:11px; color:#6b9bd2;">{upd_label}</td>
        <td colspan="2" style="{_hdr_val_s}">&nbsp;</td>
      </tr>
    </table>"""

        # ── Ops status row (independent table) ──
        ops_row_table = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_ops_label_s} {_lbl_auto}">Email:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{email}</td>
        <td style="{_ops_label_s} {_lbl_auto}">Ramp Received:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{physical}</td>
        <td style="{_ops_label_s} {_lbl_auto}">CMS Completed:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{cms}</td>
        <td style="{_ops_label_s} {_lbl_auto}">Pieces Verified:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{verified}</td>
      </tr>
      <tr>
        <td style="{_ops_label_s} {_lbl_auto}">Remarks:</td>
        <td colspan="7" style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{remarks}</td>
      </tr>
    </table>"""
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        ...
        <td colspan="6" style="{_nil_val_s}">&nbsp;</td>
      </tr>
    </table>
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_nil_ops_l} {_lbl_auto}">Email:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l} {_lbl_auto}">Ramp Received:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l} {_lbl_auto}">CMS Completed:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l} {_lbl_auto}">Pieces Verified:</td>
        <td style="{_nil_ops_v}">—</td>
      </tr>
      <tr>
        <td style="{_nil_ops_l} {_lbl_auto}">Remarks:</td>
        <td colspan="7" style="{_nil_ops_v}">—</td>
      </tr>
    </table>
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif; margin-bottom:14px;">
