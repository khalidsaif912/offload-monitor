...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr bgcolor="#1e40af">
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;width:30px;">#</td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;">AWB</td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;">PCS</td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;">KGS</td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;">Priority</td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;">Description</td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;">ULD</td>
        <td bgcolor="#1e40af" style="padding:7px 6px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;">Offloading Reason</td>
      </tr>
      <tr>
    ...
    <div style="margin-top:14px;border-radius:8px;overflow:hidden;border:1px solid #c7d4f0;font-family:Calibri,Arial,sans-serif;">
      ...
      <div style="overflow-x:auto;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;font-size:13px;">
          <tr bgcolor="#1e40af">
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;width:30px;font-size:13px;">#</td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;font-size:13px;">AWB</td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;">PCS</td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;">KGS</td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;">Priority</td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;font-size:13px;">Description</td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;text-align:center;font-size:13px;">ULD</td>
            <td bgcolor="#1e40af" style="padding:9px 8px;background-color:#1e40af;color:#ffffff;font-weight:700;border:1px solid #1e3a8a;font-size:13px;">Offloading Reason</td>
          </tr>
          {rows}
        </table>
      </div>
...
(function(){{
  ...
  function buildReportHtml(){{
    ...
    var css = [
      'body{{background:#eef1f7;font-family:Calibri,Arial,sans-serif;margin:0;padding:10px 0;-webkit-text-size-adjust:100%;}}',
      'table{{border-collapse:collapse;}}',
      'img{{max-width:100%;height:auto;display:block;}}',
      'td[bgcolor="#1e40af"]{{background-color:#1e40af!important;color:#ffffff!important;}}',
      'td[bgcolor="#1e40af"] *{{color:#ffffff!important;}}'
    ].join('');
...
<head>
  ...
  <style>
    ...
    /* إجبار Gmail على احترام ألوان خلايا الجدول */
    td[bgcolor="#1e40af"], td[bgcolor="#1e40af"] {{
