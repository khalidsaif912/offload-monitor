...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    for flight in flights:
        ...
        flight_hdr = f"""
      <tr>
        <td colspan="8" style="background-color:{hdr_bg}; padding:9px 12px; border:1px solid {hdr_border};
            font-family:Calibri,Arial,sans-serif; color:{hdr_color}; font-size:12.5px; line-height:1.3;">
          <strong style="font-size:14px;">✈ {flt}</strong>
          <span style="color:#6b9bd2;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          Date: <strong>{date}</strong>
          <span style="color:#6b9bd2;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          STD: <strong>{std_display}</strong>
          <span style="color:#6b9bd2;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          ETD: <strong>{etd_display}</strong>
          <span style="color:#6b9bd2;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          DEST: <strong style="color:#b45309;">{dest}</strong>
          <span style="color:#6b9bd2;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          <span style="font-size:11px; color:#6b9bd2;">{upd_label}</span>
        </td>
      </tr>"""
        ...
        ops_row = f"""
      <tr>
        <td colspan="8" style="background-color:#fef6ee; padding:8px 14px;
            border-left:1px solid #f0d9be; border-right:1px solid #f0d9be; border-bottom:1px solid #f0d9be;
            font-family:Calibri,Arial,sans-serif; font-size:12px; color:#5a4a3a;">
          <span style="color:#8a7560;">Email:</span> <strong style="color:#3a2e22;">{email}</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span style="color:#8a7560;">Ramp Received:</span> <strong style="color:#3a2e22;">{physical}</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span style="color:#8a7560;">CMS Completed:</span> <strong style="color:#3a2e22;">{cms}</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span style="color:#8a7560;">Pieces Verified:</span> <strong style="color:#3a2e22;">{verified}</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span style="color:#8a7560;">Remarks:</span> <strong style="color:#3a2e22;">{remarks}</strong>
        </td>
      </tr>"""
    ...
    # If no flights at all, show a NIL card (same structure as normal flight)
    if not cards_html:
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        <td colspan="8" style="background-color:{hdr_bg}; padding:9px 12px; border:1px solid {hdr_border};
            font-family:Calibri,Arial,sans-serif; color:{hdr_color}; font-size:12.5px; line-height:1.3;">
          <strong style="font-size:14px;">✈ NIL</strong>
          <span style="color:#6b9bd2;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          Date: <strong>—</strong>
          <span style="color:#6b9bd2;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          STD: <strong>—</strong>
          ...
          ETD: <strong>—</strong>
          <span style="color:#6b9bd2;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          DEST: <strong style="color:#b45309;">—</strong>
        </td>
      </tr>
      <tr>
        <td colspan="8" style="background-color:#fef6ee; padding:8px 14px;
            border-left:1px solid #f0d9be; border-right:1px solid #f0d9be; border-bottom:1px solid #f0d9be;
            font-family:Calibri,Arial,sans-serif; font-size:12px; color:#5a4a3a;">
          <span style="color:#8a7560;">Email:</span> <strong style="color:#3a2e22;">—</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span style="color:#8a7560;">Ramp Received:</span> <strong style="color:#3a2e22;">—</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span style="color:#8a7560;">CMS Completed:</span> <strong style="color:#3a2e22;">—</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span style="color:#8a7560;">Pieces Verified:</span> <strong style="color:#3a2e22;">—</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span style="color:#8a7560;">Remarks:</span> <strong style="color:#3a2e22;">—</strong>
        </td>
      </tr>
      {nil_col_headers}
      <tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                ...
                <td valign="top" style="padding-right:18px; border-right:2px solid #8b0000;">
                  ...
                  <td data-protect="transom" style="font-family:'Arial Black',Arial,sans-serif; font-size:28px;
                             font-weight:900; color:#8b0000; letter-spacing:2px; line-height:1;
                             mso-line-height-rule:exactly; mso-style-textfill-fill-color:#8b0000;">
                    <font face="Arial Black" color="#8b0000" size="6">
                      <b data-protect="transom" style="font-size:28px; color:#8b0000; font-family:'Arial Black',Arial,sans-serif; font-weight:900;">TRANSOM</b>
                    </font>
                  </td></tr>
                  <tr><td style="font-family:Arial,sans-serif; font-size:10px; font-weight:600;
                              color:#888888; letter-spacing:3px;">
                    <font face="Arial" color="#888888" size="1"><b>CARGO</b></font>
                  </td></tr></table>
                </td>
                <!-- Contact info -->
...
(function(){{
  ...
  function buildReportHtml(){{
    ...
    /* ── حماية TRANSOM من التغيير ── */
    clone.querySelectorAll('[data-protect="transom"]').forEach(function(el2){{
      el2.style.color = '#8b0000';
      el2.style.fontSize = '28px';
      el2.style.fontFamily = "'Arial Black',Arial,sans-serif";
      el2.style.fontWeight = '900';
      el2.style.letterSpacing = '2px';
      if(el2.getAttribute('bgcolor')) el2.setAttribute('bgcolor','');
    }});
    /* أيضاً البحث عن النص مباشرةً كـ fallback */
    clone.querySelectorAll('b,strong,span,font').forEach(function(el2){{
    ...
    var css = 'body{{background:#eef1f7;font-family:Calibri,Arial,sans-serif;margin:0;padding:10px 0;-webkit-text-size-adjust:100%;}}'
      + 'table{{border-collapse:collapse;table-layout:fixed;}}'
      + 'img{{max-width:100%;height:auto;display:block;}}'
      + '[data-protect="transom"]{{color:#8b0000!important;font-size:28px!important;font-family:\'Arial Black\',Arial,sans-serif!important;font-weight:900!important;}}';
    return '<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><style>' + css + '</style></head><body>' + clone.outerHTML + '</body></html>';
  }}
