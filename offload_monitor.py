...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    for flight in flights:
        ...
        # ── Flight header row (independent table) ──
        _lbl_auto = 'width:1%; white-space:nowrap;'
        flight_hdr_table = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_hdr_label_s} {_lbl_auto}">✈ Flight:</td>
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{flt}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">Date:</td>
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{date}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">STD:</td>
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{std_display}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">ETD:</td>
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{etd_display}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">DEST:</td>
        <td style="{_hdr_val_s} color:#b45309;" contenteditable="true" tabindex="{_next_ti()}">{dest}</td>
      </tr>
    </table>"""

        # ── Remarks row (independent table, row 3) ──
        remarks_table = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_hdr_label_s} {_lbl_auto}">Remarks:</td>
        <td colspan="9" style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{remarks}</td>
      </tr>
    </table>"""

        # ── Ops status row (independent table, 8 columns matching AWB table) ──
        ops_row_table = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_ops_label_s} text-align:center; width:30px;">Email:</td>
        <td style="{_ops_val_s} width:140px;" contenteditable="true" tabindex="{_next_ti()}">{email}</td>
        <td style="{_ops_label_s} text-align:center; width:55px;">Ramp:</td>
        <td style="{_ops_val_s} text-align:center; width:65px;" contenteditable="true" tabindex="{_next_ti()}">{physical}</td>
        <td style="{_ops_label_s} text-align:center; width:70px;">CMS:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{cms}</td>
        <td style="{_ops_label_s} text-align:center; width:70px;">Verified:</td>
        <td style="{_ops_val_s} width:150px;" contenteditable="true" tabindex="{_next_ti()}">{verified}</td>
      </tr>
      <tr>
        <td style="{_ops_val_s} text-align:center; width:30px;" contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td style="{_ops_val_s} width:140px;" contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td style="{_ops_val_s} text-align:center; width:55px;" contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td style="{_ops_val_s} text-align:center; width:65px;" contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td style="{_ops_val_s} text-align:center; width:70px;" contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td style="{_ops_val_s} text-align:center; width:70px;" contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td style="{_ops_val_s} width:150px;" contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
      </tr>
    </table>"""
        ...
        col_headers = (
            '<tr>'
            + _col('#', 'text-align:center; width:30px;')
            + _col('AWB:', 'width:140px;')
            + _col('PCS:', 'text-align:center; width:55px;')
            + _col('KGS:', 'text-align:center; width:65px;')
            + _col('Priority:', 'text-align:center; width:70px;')
            + _col('Description:', '')
            + _col('ULD:', 'text-align:center; width:70px;')
        ...
        <td colspan="8" style="padding:12px 10px; border:1px solid {cell_border};
          ...
          NIL — No offload data recorded.
            ...
            for idx, it in enumerate([i for i in items if (i.get("awb","") or "").strip()], 1):
                ...
                td_c = (f'style="padding:7px 8px;border:1px solid {cell_border};text-align:center;'
                        f'font-size:12px;font-family:Calibri,Arial,sans-serif;color:{text_dark};background:{bg};"')
    ...
    if not cards_html:
        _nil_label_s = (f'padding:7px 8px; background-color:{col_hdr_bg}; color:{col_hdr_clr};'
                        f'font-weight:700; font-size:11.5px; font-family:Calibri,Arial,sans-serif;'
                        f'border:1px solid {hdr_border}; white-space:nowrap;')
        _nil_val_s   = (f'padding:7px 8px; background-color:{hdr_bg}; color:{hdr_color};'
                        f'font-size:12.5px; font-family:Calibri,Arial,sans-serif;'
                        f'border:1px solid {hdr_border}; font-weight:700;')
        _nil_ops_l   = (f'padding:7px 8px; background-color:{col_hdr_bg}; color:#8a7560;'
                        f'font-weight:700; font-size:11.5px; font-family:Calibri,Arial,sans-serif;'
                        f'border:1px solid #f0d9be; white-space:nowrap;')
        _nil_ops_v   = (f'padding:7px 8px; background-color:#fef6ee; color:#3a2e22;'
                        f'font-size:12px; font-family:Calibri,Arial,sans-serif;'
                        f'border:1px solid #f0d9be; font-weight:700;')

        def _nil_col(label, extra=""):
            return (f'<td style="padding:7px 8px; background-color:{col_hdr_bg}; color:{col_hdr_clr};'
                    f'font-weight:700; font-size:11.5px; font-family:Calibri,Arial,sans-serif;'
                    f'border:1px solid {hdr_border}; {extra}">{label}</td>')
        ...
        nil_col_headers = (
            '<tr>'
            + _nil_col('#', 'text-align:center; width:30px;')
            + _nil_col('AWB:', 'width:140px;')
            + _nil_col('PCS:', 'text-align:center; width:55px;')
            + _nil_col('KGS:', 'text-align:center; width:65px;')
            + _nil_col('Priority:', 'text-align:center; width:70px;')
            + _nil_col('Description:', '')
            + _nil_col('ULD:', 'text-align:center; width:70px;')
            + _nil_col('Offloading Reason:', 'width:150px;')
            + '</tr>'
        )
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_nil_label_s} {_lbl_auto}">✈ Flight:</td>
        <td style="{_nil_val_s}">NIL</td>
        <td style="{_nil_label_s} {_lbl_auto}">Date:</td>
        <td style="{_nil_val_s}">—</td>
        <td style="{_nil_label_s} {_lbl_auto}">STD:</td>
        <td style="{_nil_val_s}">—</td>
        <td style="{_nil_label_s} {_lbl_auto}">ETD:</td>
        <td style="{_nil_val_s}">—</td>
        <td style="{_nil_label_s} {_lbl_auto}">DEST:</td>
        <td style="{_nil_val_s} color:#b45309;">—</td>
      </tr>
    </table>
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_nil_ops_l} text-align:center; width:30px;">Email:</td>
        <td style="{_nil_ops_v} width:140px;">—</td>
        <td style="{_nil_ops_l} text-align:center; width:55px;">Ramp:</td>
        <td style="{_nil_ops_v} text-align:center; width:65px;">—</td>
        <td style="{_nil_ops_l} text-align:center; width:70px;">CMS:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l} text-align:center; width:70px;">Verified:</td>
        <td style="{_nil_ops_v} width:150px;">—</td>
      </tr>
      <tr>
        <td style="{_nil_ops_v} text-align:center; width:30px;">&nbsp;</td>
        <td style="{_nil_ops_v} width:140px;">&nbsp;</td>
        <td style="{_nil_ops_v} text-align:center; width:55px;">&nbsp;</td>
        <td style="{_nil_ops_v} text-align:center; width:65px;">&nbsp;</td>
        <td style="{_nil_ops_v} text-align:center; width:70px;">&nbsp;</td>
        <td style="{_nil_ops_v}">&nbsp;</td>
        <td style="{_nil_ops_v} text-align:center; width:70px;">&nbsp;</td>
        <td style="{_nil_ops_v} width:150px;">&nbsp;</td>
      </tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_nil_label_s} {_lbl_auto}">Remarks:</td>
        <td colspan="9" style="{_nil_val_s}">—</td>
      </tr>
    </table>
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif; margin-bottom:14px;">
