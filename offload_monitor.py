...
def build_nil_shift_report(date_dir: str, shift: str, now) -> None:
    """Build a NIL shift report by calling build_shift_report with empty data."""
    out_file = DOCS_DIR / date_dir / shift / "index.html"
    if out_file.exists():
        return
    # أنشئ مجلد البيانات فارغاً مع meta.json فارغ مؤقتاً
    ...
    if not meta_file.exists():
        ...
        created_meta = True
    # استخدم build_shift_report مباشرة
