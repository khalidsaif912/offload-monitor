    ...
    <style>
        ...
        *, *::before, *::after {{ box-sizing:border-box; margin:0; padding:0; }}
        ...
        .mp-box {{
            ...
            width:94%; max-width:520px; max-height:80vh;
        ...
        .mp-title {{ font-size:15px; font-weight:800; color:var(--navy); }}
        .mp-copy {{
        ...
        .mp-dept {{ font-size:12px; font-weight:800; color:var(--navy); text-transform:uppercase; letter-spacing:.5px; margin:12px 0 4px; }}
        .mp-emp {{ font-size:13px; color:#334155; margin:2px 0 2px 12px; }}
        .mp-emp span {{ color:var(--muted); }}
        .mp-loading {{ text-align:center; padding:30px; color:var(--muted); font-size:13px; }}
...
<body>
    ...
    <div class="mp-overlay" id="mp-overlay" onclick="if(event.target===this)closeManpower()">
        <div class="mp-box">
            <button class="mp-close" onclick="closeManpower()">&times;</button>
            <div class="mp-header">
        ...
        .then(function(json) {{
            ...
            for (var dept in grouped) {{
                ...
                grouped[dept].forEach(function(e) {{
                    html += '<div class="mp-emp"><span>SN ' + e.sn + '</span> — ' + e.name + '</div>';
                }});
            }}
            el.innerHTML = html;
            mpData = grouped;
