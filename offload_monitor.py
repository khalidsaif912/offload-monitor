            ...
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                ...
                <td valign="top" style="padding-right:18px; border-right:2px solid #8b0000;">
                  ...
                  <td style="font-family:'Arial Black',Arial,sans-serif; font-size:28px; font-weight:900;
                             color:#8b0000; letter-spacing:2px; line-height:1;
                             mso-line-height-rule:exactly; mso-style-textfill-fill-color:#8b0000;">
                    <font face="Arial Black" color="#8b0000" size="6">
                      <b style="font-size:28px; color:#8b0000; mso-style-textfill-fill-color:#8b0000;">TRANSOM</b>
                    </font>
                  </td></tr>
                  <tr><td style="font-family:Arial,sans-serif; font-size:10px; font-weight:600;
                              color:#888888; letter-spacing:3px; margin-top:2px;">
