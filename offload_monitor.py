...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    for flight in flights:
      ...
      <tr>
        ...
        ops_row = f"""
      <tr>
        <td colspan="8" style="background-color:{ops_bg}; padding:6px 12px;
            border-left:1px solid {ops_border}; border-right:1px solid {ops_border}; border-bottom:1px solid {ops_border};
            font-family:Calibri,Arial,sans-serif; font-size:11px; color:{text_dark};">
          Email: <strong>{email or 'Pending'}</strong>
          <span style="color:#8aa2c7;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          Ramp Received: <strong>{physical or 'Pending'}</strong>
          <span style="color:#8aa2c7;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          CMS Completed: <strong>{cms or 'Pending'}</strong>
          <span style="color:#8aa2c7;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          Pieces Verified: <strong>{verified or 'Pending'}</strong>
          <span style="color:#8aa2c7;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
