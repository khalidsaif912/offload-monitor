...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        ...
        # ── Ops + Remarks row (single row) ──
        ops_row_table = f"""
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_ops_label_s} text-align:center;">Email:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{email}</td>
        <td style="{_ops_label_s} text-align:center;">Ramp:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{physical}</td>
        <td style="{_ops_label_s} text-align:center;">CMS:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{cms}</td>
        <td style="{_ops_label_s} text-align:center;">Verified:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{verified}</td>
        <td style="{_ops_label_s} text-align:center;">Remarks:</td>
        <td style="{_ops_val_s}" contenteditable="true" tabindex="{_next_ti()}">{remarks}</td>
      </tr>
    </table>"""
      ...
      <tr>
        ...
        _empty_td_c = (f'style="padding:7px 8px;border:1px solid {cell_border};text-align:center;'
                       f'font-size:12px;font-family:Calibri,Arial,sans-serif;color:{text_dark};background:{row_even};"')
        _empty_td_s = (f'style="padding:7px 8px;border:1px solid {cell_border};'
                       f'font-size:12px;font-family:Calibri,Arial,sans-serif;color:{text_dark};background:{row_even};"')
        empty_row = f"""
      <tr>
        <td {_empty_td_c} contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td {_empty_td_s} contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td {_empty_td_c} contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td {_empty_td_c} contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td {_empty_td_c} contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
        <td {_empty_td_s} contenteditable="true" tabindex="{_next_ti()}">&nbsp;</td>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_nil_ops_l} text-align:center;">Email:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l} text-align:center;">Ramp:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l} text-align:center;">CMS:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l} text-align:center;">Verified:</td>
        <td style="{_nil_ops_v}">—</td>
        <td style="{_nil_ops_l} text-align:center;">Remarks:</td>
        <td style="{_nil_ops_v}">—</td>
      </tr>
    </table>
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
