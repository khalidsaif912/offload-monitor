...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        ...
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{email}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">Ramp:</td>
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{physical}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">CMS:</td>
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{cms}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">Verified:</td>
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{verified}</td>
        <td style="{_hdr_label_s} {_lbl_auto}">Remarks:</td>
        <td style="{_hdr_val_s}" contenteditable="true" tabindex="{_next_ti()}">{remarks}</td>
      </tr>
    </table>"""
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
           style="border-collapse:collapse; font-family:Calibri,Arial,sans-serif;">
      <tr>
        <td style="{_nil_label_s} {_lbl_auto}">Email:</td>
        <td style="{_nil_val_s}">—</td>
        <td style="{_nil_label_s} {_lbl_auto}">Ramp:</td>
        <td style="{_nil_val_s}">—</td>
        <td style="{_nil_label_s} {_lbl_auto}">CMS:</td>
        <td style="{_nil_val_s}">—</td>
        <td style="{_nil_label_s} {_lbl_auto}">Verified:</td>
        <td style="{_nil_val_s}">—</td>
