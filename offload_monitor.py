...
def _render_offload_table(flights: list[dict], meta: dict) -> str:
    ...
    for flight in flights:
        ...
        upd_label = f'Updated: <strong style="color:#ffffff;">{upd_at}</strong>' if upd_at else ""
      ...
      <tr>
        <td colspan="8" style="background-color:{hdr_bg}; padding:9px 12px; border:1px solid {hdr_border};
          ...
          <span style="color:#8aafe0;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          DEST: <strong style="color:#fbbf24;">{dest}</strong>
          <span style="color:#8aafe0;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          <span style="font-size:11px; color:#8aafe0;">{upd_label}</span>
        </td>
      </tr>"""
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        <td colspan="8" style="background-color:{hdr_bg}; padding:9px 12px; border:1px solid {hdr_border};
          ...
          ETD: <strong>—</strong>
          <span style="color:#8aafe0;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
          DEST: <strong style="color:#fbbf24;">—</strong>
        </td>
      </tr>
      <tr>
        <td colspan="8" style="background-color:#fef6ee; padding:8px 14px;
