            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="background-color:#0b3a78;">
              <tr>
                <td data-email-banner="1" style="background-color:#0b3a78;">
                  <div style="font-family:Calibri,Arial,sans-serif; font-size:21px; font-weight:800; color:#ffffff !important; letter-spacing:0.5px; line-height:1.25; mso-line-height-rule:exactly;">
                    &#9992;&nbsp; Export Warehouse Activity Report
                  </div>
                  <div style="font-family:Calibri,Arial,sans-serif; font-size:13px; color:#ffffff !important; margin-top:7px; letter-spacing:0.2px; opacity:0.92;">
                    Shift Date:&nbsp;<strong style="color:#fde68a !important; font-weight:700;">{date_display}</strong>
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    Time:&nbsp;<strong style="color:#fde68a !important; font-weight:700;">{sl['time']} LT</strong>
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    <strong style="color:#fde68a !important; font-weight:700;">{sl['en']} Shift</strong>
                  </div>
                </td>
                <td align="right" valign="middle" data-email-banner="1" style="padding-right:6px; background-color:#0b3a78;">
                  <div style="font-family:Calibri,Arial,sans-serif; font-size:12px; color:#93c5fd !important; line-height:1.5; text-align:right;">
                    Oman SATS LLC<br>
                    <strong style="color:#ffffff !important; font-weight:700;">Export Operations</strong>
                  </div>
                </td>
              </tr>
            </table>
...
(function(){{
  ...
  function forceReadableContrast(node){{
    ...
    /* Skip banner elements — they use intentional dark bg with white text */
    if(node.getAttribute && node.getAttribute('data-email-banner')) return;
    var p = node.parentElement;
    while(p){{ if(p.getAttribute && p.getAttribute('data-email-banner')) return; p = p.parentElement; }}
  ...
  function buildReportHtml(){{
    ...
    clone.querySelectorAll('td,th,tr,div,span,strong').forEach(function(el2){{
      /* Skip banner elements — handled above */
      ...
      /* Fix white text globally (outside banner) */
